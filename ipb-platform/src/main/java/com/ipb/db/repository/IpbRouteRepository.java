...
import com.ipb.db.entity.IpbRoute;

/**
 * Interface used for manipulating ROUTE data in the database.
 * 
 ...
 */
public interface IpbRouteRepository extends JpaRepository<IpbRoute, Long> {
