...
import com.ipb.db.entity.IpbProposal;

/**
 * Interface used for manipulating PROPOSAL data in the database.
 * 
 ...
 */
public interface IpbProposalRepository extends JpaRepository<IpbProposal, Long> {
