...
import com.ipb.db.entity.IpbImage;

/**
 * Interface used for manipulating IMAGES data in the database.
 * 
 ...
 */
public interface IpbImageRepository extends JpaRepository<IpbImage, Long> {
