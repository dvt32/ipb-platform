...
import com.ipb.db.entity.IpbLandmark;

/**
 * Interface used for manipulating LANDMARKS data in the database.
 * 
 ...
 */
public interface IpbLandmarkRepository extends JpaRepository<IpbLandmark, Long> {
