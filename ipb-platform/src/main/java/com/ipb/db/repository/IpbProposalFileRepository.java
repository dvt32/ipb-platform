...
import com.ipb.db.entity.IpbProposalFile;

/**
 * Interface used for manipulating PROPOSAL FILE data in the database.
 * 
 ...
 */
public interface IpbProposalFileRepository extends JpaRepository<IpbProposalFile, Long> {
